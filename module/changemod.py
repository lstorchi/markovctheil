...
def compute_three_cp_fake (rm, c_p1, c_p2, c_p3, errmsg):
    ...
    for i in range(rating):
         ...
         if (den2 > 0.0):
             for j in range(rating):
                val = numpy.float64(num2[i,j])/numpy.float64(den2)
                if (val > 0.0):
                    L2 += num2[i,j]*math.log(val) 
    ...
    for i in range(rating):
         ...
         if (den3 > 0.0):
             for j in range(rating):
                val = numpy.float64(num3[i,j])/numpy.float64(den3)
                if (val > 0.0):
                    L3 += num3[i,j]*math.log(val) 
    ...
    for i in range(rating):
         ...
         if (den4 > 0.0):
             for j in range(rating):
                val = numpy.float64(num4[i,j])/numpy.float64(den4)
                if (val > 0.0):
                    L4 += num4[i,j]*math.log(val) 
